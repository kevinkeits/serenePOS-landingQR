...
const Search = () => {
  return (
    <div className=' w-full max-w-md mx-auto py-2 px-2'>
        <div className='w-full flex items-center py-2 px-2 border bg-white border-gray-300 shadow-md rounded-lg focus:ring-gray-300 focus:border-gray-300 focus:ring focus:ring-opacity-50 '>
